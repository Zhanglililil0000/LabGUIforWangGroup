...
FilePath = 'D:\\2024\\zhangli\\20240611\\CYCData\\30mWLoss\\VoutHR'
...
def SRS_WavelengthScan(DataName,CenterWavelength,Frames):
...
if __name__ == "__main__":
    ...
    for CW in np.arange(450, 511, 10.0):
        SRS_WavelengthScan("CYCVV1800g50000Frames"+str(format(CW, ".4f")).replace(".", "_")+"nm",
                 CW,
                 50000)
    ...
    for CW in np.arange(450, 511, 10.0):
        SRS_WavelengthScan("CYCHV1800g50000Frames"+str(format(CW, ".4f")).replace(".", "_")+"nm",
                CW,
                50000)
