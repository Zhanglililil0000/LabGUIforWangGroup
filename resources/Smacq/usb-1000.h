...
int _stdcall USB1ReadDevcieSN(int DevIndex);
...
int _stdcall SetAcqMode(int DevIndex, unsigned char AcqMode);
int _stdcall SetOneShotPts(int DevIndex, unsigned int Pts);
...
int _stdcall ReadCali(int DevIndex, float *Parameters);
